...
class GW3F extends Growatt
{
    ...
    public static $Variables = [
		['Input power high ', vtInteger, 'Watt-Int', 0x0000, 4,1 ,true],
		['Input power low ', vtInteger, 'Watt-Int', 0x0001, 4,1 ,true],
		['PV1 voltage ', vtInteger, 'Volt-Int', 0x0002, 4,1 ,true],
		['PV1 input current ', vtInteger, 'Ampere-Int', 0x0003, 4,1 ,true],
		['PV1 input watt high ', vtInteger, 'Watt-Int', 0x0004, 4,1 ,true],
		['PV1 input watt low ', vtInteger, 'Watt-Int', 0x0005, 4,1 ,true],
		['PV2 voltage ', vtInteger, 'Volt-Int', 0x0006, 4,1 ,true],
		['PV2 input current ', vtInteger, 'Ampere-Int', 0x0007, 4,1 ,true],
		['PV2 input watt high ', vtInteger, 'Watt-Int', 0x0008, 4,1 ,true],
		['PV2 input watt low ', vtInteger, 'Watt-Int', 0x0009, 4,1 ,true],
		['Output power high ', vtInteger, 'Watt-Int', 0x000A, 4,1 ,true],
		['Output power low ', vtInteger, 'Watt-Int', 0x000B, 4,1 ,true],
		['Grid frequency ', vtInteger, 'Hertz-Int', 0x000C, 4,1 ,true],
		['L1 phase grid voltage ', vtInteger, 'Volt-Int', 0x000D, 4,1 ,true],
		['L1 phase grid output current ', vtInteger, 'Ampere-Int', 0x000E, 4,1 ,true],
		['L1 phase grid output watt high ', vtInteger, 'VA-Int', 0x000F, 4,1 ,true],
		['L1 phase grid output watt low ', vtInteger, 'VA-Int', 0x0010, 4,1 ,true],
		['L2 Three phase grid voltage ', vtInteger, 'Volt-Int', 0x0011, 4,1 ,true],
		['L2 Three phase grid output current ', vtInteger, 'Ampere-Int', 0x0012, 4,1 ,true],
		['L2 Three phase grid output power high ', vtInteger, 'VA-Int', 0x0013, 4,1 ,true],
		['L2 Three phase grid output power low ', vtInteger, 'VA-Int', 0x0014, 4,1 ,true],
		['L3 Three phase grid voltage ', vtInteger, 'Volt-Int', 0x0015, 4,1 ,true],
		['L3 Three phase grid output current ', vtInteger, 'Ampere-Int', 0x0016, 4,1 ,true],
		['L3 Three phase grid output power high ', vtInteger, 'VA-Int', 0x0017, 4,1 ,true],
		['L3 Three phase grid output power low ', vtInteger, 'VA-Int', 0x0018, 4,1 ,true],
		['Energy today high ', vtInteger, 'Power-Int', 0x0019, 4,1 ,true],
		['Energy today low ', vtInteger, 'Power-Int', 0x001A, 4,1 ,true],
		['Energy total high ', vtInteger, 'Power-Int', 0x001B, 4,1 ,true],
		['Energy total low ', vtInteger, 'Power-Int', 0x001C, 4,1 ,true],
		['Work time total high ', vtInteger, '', 0x001D, 4,1 ,true],
		['Work time total low ', vtInteger, '', 0x001E, 4,1 ,true],
		['Temperature Inverter ', vtInteger, 'Temperature-Int', 0x001F, 4,1 ,true],
		['ISO Fault value ', vtInteger, 'Volt-Int', 0x0020, 4,1 ,true],
		['GFCI fault Value ', vtInteger, 'mA-Int', 0x0021, 4,1 ,true],
		['DCI fault Value ', vtInteger, 'Ampere-Int', 0x0022, 4,1 ,true],
		['PV voltage fault value ', vtInteger, 'Volt-Int', 0x0023, 4,1 ,true],
		['AC voltage fault value ', vtInteger, 'Volt-Int', 0x0024, 4,1 ,true],
		['AC frequency fault value ', vtInteger, 'Hertz-Int', 0x0025, 4,1 ,true],
		['Temperature fault value ', vtInteger, 'Temperature-Int', 0x0026, 4,1 ,true],
		['Inverter fault bit', vtInteger, '', 0x0027, 4,1 ,true],
		['IPM in inverter Temperature ', vtInteger, 'Temperature-Int', 0x0028, 4,1 ,true],
		['P Bus inside Voltage ', vtInteger, 'Volt-Int', 0x0029, 4,1 ,true],
		['N Bus inside Voltage ', vtInteger, 'Volt-Int', 0x002A, 4,1 ,true],
		...
		['PV Energy today ', vtInteger, 'Power-Int', 0x0030, 4,1 ,true],
		['PV Energy total', vtInteger, '', 0x0031, 4,1 ,true],
		['PV Energy total ', vtInteger, 'Power-Int', 0x0032, 4,1 ,true],
		['PV Energy today', vtInteger, '', 0x0033, 4,1 ,true],
		['PV Energy today ', vtInteger, 'Power-Int', 0x0034, 4,1 ,true],
		['PV Energy total', vtInteger, '', 0x0035, 4,1 ,true],
		['PV Energy total ', vtInteger, 'Power-Int', 0x0036, 4,1 ,true],
		['PV Energy total', vtInteger, '', 0x0037, 4,1 ,true],
		['PV Energy total ', vtInteger, 'Power-Int', 0x0038, 4,1 ,true],
		['AC Reactive power', vtInteger, '', 0x0039, 4,1 ,true],
		['AC Reactive power ', vtInteger, 'VAr-Int', 0x003A, 4,1 ,true],
		['AC Reactive energy', vtInteger, '', 0x003B, 4,1 ,true],
		['AC Reactive energy ', vtInteger, 'kVArh-Int', 0x003C, 4,1 ,true],
		['AC Reactive energy', vtInteger, '', 0x003D, 4,1 ,true],
		['AC Reactive energy ', vtInteger, 'kVArh-Int', 0x003E, 4,1 ,true],
